...
export async function listAllRecipes(_managed: ManagedBot, category?: string): Promise<string> {
  ...
  const recipes: Record<string, { name: string; ingredients: string }[]> = {
    ...
    armor: [
      ...
      { name: "golden_helmet", ingredients: "5 gold_ingot (good for Nether: prevents Piglin aggro)" },
      { name: "golden_chestplate", ingredients: "8 gold_ingot (good for Nether: prevents Piglin aggro)" },
      { name: "golden_leggings", ingredients: "7 gold_ingot (good for Nether: prevents Piglin aggro)" },
      { name: "golden_boots", ingredients: "4 gold_ingot (good for Nether: prevents Piglin aggro)" },
    ],
    basics: [
...
export async function listCraftableNow(managed: ManagedBot): Promise<string> {
  ...
  const allRecipes = [
    ...
    { name: "golden_helmet", needs: { gold_ingot: 5 } },
    { name: "golden_chestplate", needs: { gold_ingot: 8 } },
    { name: "golden_leggings", needs: { gold_ingot: 7 } },
    { name: "golden_boots", needs: { gold_ingot: 4 } },
...
export async function craftItem(managed: ManagedBot, itemName: string, count: number = 1): Promise<string> {
  ...
  if (recipes.length === 0) {
    const armorRecipes: Record<string, { material: string; shape: number[][]; materialCount: number }> = {
      ...
      "golden_helmet":    { material: "gold_ingot", shape: [[1,1,1],[1,0,1]],             materialCount: 5 },
      "golden_chestplate":{ material: "gold_ingot", shape: [[1,0,1],[1,1,1],[1,1,1]],     materialCount: 8 },
      "golden_leggings":  { material: "gold_ingot", shape: [[1,1,1],[1,0,1],[1,0,1]],     materialCount: 7 },
      "golden_boots":     { material: "gold_ingot", shape: [[1,0,1],[1,0,1]],             materialCount: 4 },
