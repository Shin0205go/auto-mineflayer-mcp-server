---
name: ender-dragon
description: エンダードラゴン討伐。準備・戦略・手順（mc_execute用）
---
## 必要アイテム
- ダイヤ/ネザライト装備一式（Protection IV推奨）
- ダイヤ剣（Sharpness V）、弓（Power V+）+ 矢192本
- ender_eye x12（blaze_powder+ender_pearl）
